...
with vAR_st.sidebar:
    vAR_selected=vAR_st.selectbox("Menu",('Data type', 'Rounding Off','Arithmetic Operation','BMI','Unit Conversion','Compare two numbers','Sorting Order',"OddEven, Quotient and Remainder"))
...
if vAR_st.markdown=="Sorting Order":
